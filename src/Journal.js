...
export default function Journal({ target, hidden = true, navigateToForm }) {
    ...
    const buttonToForm = Button({ text: 'Rate Today ⭑', className: 'button btn-200 shadow-orange', target: buttonWrapper })

    //buttonToForm.addEventListener('click', () => navigateToForm)
